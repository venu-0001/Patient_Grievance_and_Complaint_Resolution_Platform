...
{
    public class OpenRouterRoutingService
    {
        ...
        public OpenRouterRoutingService(HttpClient httpClient, string configFilePath, string outputPath, List<InvestigatorDto> investigatorDto)
        {
            _httpClient = httpClient;
            _configFilePath = configFilePath;
            _outputFilePath = outputPath;
            _investigatorDto = investigatorDto;
            _apiKey = Environment.GetEnvironmentVariable("OPENAI_API_KEY", EnvironmentVariableTarget.Process)
