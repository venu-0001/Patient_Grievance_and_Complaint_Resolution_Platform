...
namespace Patient_Grievance_and_Complaint_Resolution.Data;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=.;Database=GrievanceResolutionDB;Trusted_Connection=True;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Grievance>(entity =>
        {
            ...
            entity.Property(e => e.StatusId).HasColumnName("status_id");
            entity.Property(e => e.GrievanceSummary)
    .HasMaxLength(1000)
    .IsUnicode(false)
    .HasColumnName("grievance_summary");
        ...
        // =========================================
        // INVESTIGATOR -> USER Relationship
        // =========================================

        modelBuilder.Entity<Investigator>()
            .HasOne(i => i.User)
            .WithMany(u => u.Investigators)
